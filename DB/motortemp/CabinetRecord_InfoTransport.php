...
class CabinetRecordToXML extends SqlConnection
{
	...
	{
		$res=odbc_exec($con,"select a.*,b.TypeName from sbzlb a left  join sbzlb_djfs c on a.id=c.iSbid left join CabinetRecordType b on b.id = c.idjid  where c.iDjid is not null");
