...
namespace DeviceAuto
{
    ...
    /// gzxx_load 的摘要说明
    /// </summary>
    public class gzxx_load : IHttpHandler
    {
            ...
            if (CRow.Length > 0)
            {
                ...
                for (int i = 0; i < CRow.Length; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(chidstring))
                    {
                        ...
                        sb.Append("{ \"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["cgzxx"].ToString() + "\",\"state\":\"open\",\"children\":");
                    ...
                    else
                    {
                        ...
                        {
                            //state为closed时折叠
                            sb.Append("{\"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["cgzxx"].ToString() + "\"},");
