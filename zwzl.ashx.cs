...
namespace DeviceAuto
{
    ...
    /// zwzl 的摘要说明
    /// </summary>
    public class zwzl : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                dt = SqlHelper.GetTable("select * from zwzlb order by pid");
            ...
            if (CRow.Length > 0)
            {
                ...
                for (int i = 0; i < CRow.Length; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(chidstring))
                    {
                        ...
                        sb.Append("{ \"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["czwmc"].ToString() + "\",\"state\":\"open\",\"children\":");
                    ...
                    else
                    {
                        ...
                        {
                            //state为closed时折叠
                            sb.Append("{\"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["czwmc"].ToString() + "\"},");
                        }
