...
namespace DeviceAuto
{
    ...
    /// bmzl 的摘要说明
    /// </summary>
    public class bmzl : IHttpHandler, IRequiresSessionState
    {
            ...
            if (CRow.Length > 0)
            {
                ...
                for (int i = 0; i < CRow.Length; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(chidstring))
                    {
                        ...
                        sb.Append("{ \"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["cbmmc"].ToString() + "\",\"state\":\"open\",\"children\":");
                    ...
                    else
                    {
                        ...
                        {
                            //state为closed时折叠
                            sb.Append("{\"id\":\"" + CRow[i]["id"].ToString() + "\",\"text\":\"" + CRow[i]["cbmmc"].ToString() + "\"},");
